    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="index.do" class="flex items-center space-x-3 rtl:space-x-reverse">
          <img src="static/media/logos/legal-breeze-logo.png" class="h-8" alt="Flowbite Logo" />
        </a>
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
          <ul
            ...
            <li>
              <c:choose>
                <c:when test="${user==null}">
                  <a href="signin.do"
                    class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Log
                    In</a>
                </c:when>
            ...
            <li>
              <c:choose>
                <c:when test="${user!=null}">
                  ...
                  <c:choose>
                    <c:when test="${user.userType.userTypeId==1}">
                      <c:out value="href=dashboard.do" />
                    </c:when>
                    <c:otherwise>
                      <c:out value="href=provider_dashboard.do" />
                    </c:otherwise>
                  </c:choose>
            ...
            <li>
              <a href="signup.do"
                class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Signup</a>
            </li>
            </c:otherwise>
            </c:choose>
            </li>
