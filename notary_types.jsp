          ...
          <c:forEach var="notaryType" items="${notaryTypes}">
            <li class="me-2" role="presentation">
              <button
                ...
                id="${notaryType.typeName}-styled-tab"
                data-tabs-target="#styled-${notaryType.typeName}"
                type="button"
                role="tab"
                aria-controls="${notaryType.typeName}"
                aria-selected="false"
              >
                ${notaryType.typeName}
              </button>
      ...
      <div id="default-styled-tab-content">
        <c:forEach var="notaryType" items="${notaryTypes}">
          <div
            ...
            id="styled-${notaryType.typeName}"
            role="tabpanel"
            aria-labelledby="${notaryType.typeName}-tab"
          >
            <p class="text-sm text-gray-500 dark:text-gray-400">
              <div class="flow-root">
                <ul role="list" class="divide-gray-200 dark:divide-gray-700">
                  <c:forEach var="notary" items="${allNotaries}">
                    <c:if
                      test="${notary.providerType.providerTypeId==notaryType.providerTypeId}"
                    >
                                  ...
                                  <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <form class="p-4 md:p-5" action="save_case.do">
                                      <div class="grid gap-4 mb-4 grid-cols-2">
                                        ...
                                        <div class="hidden">
                                          <input type="number" name="provider_id" value="${notary.userId}">
                                        </div>
                                        <div class="col-span-2 sm:col-span-1">
                                          <label for="deadline"
