          ...
          <c:forEach var="lawyerType" items="${lawyerTypes}">
            <li class="me-2" role="presentation">
              <button
                ...
                id="${lawyerType.typeName}-styled-tab"
                data-tabs-target="#styled-${lawyerType.typeName}"
                type="button"
                role="tab"
                aria-controls="${lawyerType.typeName}"
                aria-selected="false"
              >
                ${lawyerType.typeName}
              </button>
      ...
      <div id="default-styled-tab-content">
        <c:forEach var="lawyerType" items="${lawyerTypes}">
          <div
            ...
            id="styled-${lawyerType.typeName}"
            role="tabpanel"
            aria-labelledby="${lawyerType.typeName}-tab"
          >
            <p class="text-sm text-gray-500 dark:text-gray-400">
              <div class="flow-root">
                <ul role="list" class="divide-gray-200 dark:divide-gray-700">
                  <c:forEach var="lawyer" items="${allLawyers}" varStatus="n">
                    <c:if
                      test="${lawyer.providerType.providerTypeId==lawyerType.providerTypeId}"
                    >
                        ...
                        >
                          ...
                          >
                            <div class="space-y-2">
                              ...
                              <div class="flex flex-row leading-normal">
                                <button data-modal-target="crud-modal-${n.count}" data-modal-toggle="crud-modal-${n.count}" class="text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2" type="button">
                                  Hire now
                                </button>
<!-- Main modal -->
<div id="crud-modal-${n.count}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="crud-modal-${n.count}">
            ...
            <form class="p-4 md:p-5" action="save_case.do">
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        <label for="issue" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Issue</label>
                        <input type="text" name="issue" id="issue" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Subject of the case" required>
                    </div>
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        <label for="court" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Court</label>
                        <select id="court" name="court" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
