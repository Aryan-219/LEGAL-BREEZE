  ...
  <body class="bg-gray-900 md:px-24 px-0">
    ...
    <main>
          ...
          <c:forEach var="lawyerType" items="${lawyerTypes}">
            <li class="me-2" role="presentation">
              <button
                ...
                id="${lawyerType.typeName}-styled-tab" data-tabs-target="#styled-${lawyerType.typeName}" type="button"
                role="tab" aria-controls="${lawyerType.typeName}" aria-selected="false">
                ${lawyerType.typeName}
              </button>
            </li>
          </c:forEach>
      ...
      <div id="default-styled-tab-content">
        <c:forEach var="lawyerType" items="${lawyerTypes}">
          <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="styled-${lawyerType.typeName}"
            role="tabpanel" aria-labelledby="${lawyerType.typeName}-tab">
            <p class="text-sm text-gray-500 dark:text-gray-400">
            <div class="flow-root">
              <ul role="list" class="divide-gray-200 dark:divide-gray-700">
                <c:forEach var="lawyer" items="${allLawyers}" varStatus="n">
                  <c:if test="${lawyer.providerType.providerTypeId==lawyerType.providerTypeId}">
                    <li class="py-3 sm:py-4">
                      <a href="#"
                        ...
                        <c:choose>
                          <c:when test="${lawyer.profilePic==null}">
                          ...
                          <c:otherwise>
                            ...
                            <img
                              class="object-cover w-full rounded-t-lg h-96 md:h-full md:w-[300px] md:rounded-none md:rounded-s-lg"
                              src="get_profile_pic.do?email=${lawyer.email}&profile_pic=${lawyer.profilePic}" alt="Lawyer Image" />
                          </c:otherwise>
                        </c:choose>
